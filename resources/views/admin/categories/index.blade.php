...
@section('content_header')
    ...
    <a class="btn btn-sm float-right btn-info" href="{{ route('admin.categories.create') }}"><i class="fas fa-plus-circle"></i> Agregar una nueva categoría</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('body').on("click", '.eliminar',function(e){
                ...
                Swal.fire({
                    title: '¿Esta seguro que desea borrar la categoría?',
