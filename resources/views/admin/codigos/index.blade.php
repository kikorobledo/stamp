...
@section('content_header')
    ...
    <a class="btn btn-sm btn-info float-right" href="{{ route('admin.codigos.create')}}">Crear nuevo código</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('body').on("click", '.eliminar',function(e){
                ...
                Swal.fire({
                    title: '¿Esta seguro que desea borrar el codigo?',
