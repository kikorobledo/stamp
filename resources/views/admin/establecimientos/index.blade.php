...
@section('content_header')
    ...
    <a href="{{ route('admin.establecimientos.create') }}" class="btn btn-info float-right btn-sm"><i class="fas fa-plus-circle"></i> Agregar  nuevo establecimiento</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let t = $('#table').DataTable({
                ...
                "ajax":"{{ route('datatable.establecimientos') }}",
                "columns":[
                    {data: null},
                    {data: 'imagen'},
                    {data: 'nombre'},
            ...
            $('body').on("click", '.eliminar',function(e){
                ...
                Swal.fire({
                    title: '¿Esta seguro que desea borrar el establecimiento?',
