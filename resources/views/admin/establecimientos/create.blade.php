...
@section('content_header')
    <h1>Ingresar nuevo Establecimiento</h1>
@stop
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {!! Form::open(['route' => 'admin.establecimientos.store', 'autocomplete' => 'off', 'files' => true]) !!}
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <fieldset class="border p-4">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::hidden('premium', 0, ['id' => 'premium']) !!}
            ...
            {!! Form::submit('Ingresar Establecimiento', ['class' => 'btn btn-primary mt-4 float-right']) !!}
