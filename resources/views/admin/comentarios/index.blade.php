...
@section('content_header')
    ...
    <a class="btn btn-sm btn-info float-right" href="{{ route('admin.comentarios.create')}}">Crear nuevo comentario</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let t = $('#table').DataTable({
                ...
                "ajax":"{{ route('datatable.comentarios') }}",
                "columns":[
                    {data: null},
                    {data: 'contenido'},
                    {data: 'user_id'},
            ...
            $('body').on("click", '.eliminar',function(e){
                ...
                Swal.fire({
                    title: '¿Esta seguro que desea borrar el comentario?',
