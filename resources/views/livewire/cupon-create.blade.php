        ...
        <div class="md:col-span-1">
            ...
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Ingresa los datos pricipales de tu cupón
                </p>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input wire:model="codigos" type="number" min="0" name="codigos" id="codigos" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <input wire:model="fecha_de_vencimiento" type="date" name="fecha_de_vencimiento" id="fecha_de_vencimiento" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full">
