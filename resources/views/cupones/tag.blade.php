<x-app-layout>
    ...
    <div class="container">
        ...
        <h1 class="text-4xl font-thin text-gray-600 mb-4 mt-5">Cupones Para {{ $tag->nombre }}</h1>

        {{-- <h1 class="uppercase text-center text-3xl font-bold mt-5">Tag: {{ $tag->nombre }}</h1> --}}
